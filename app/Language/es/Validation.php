...
return [
    ...
    "alpha_numeric_es"  =>      "El campo '{field}' debe contener campos alfanuméricos, espacio y caracteres propios del español",
    "user_name"         =>      "El campo '{field}' no es valido, velique e intente nueva mente",
    "no_space"          =>      "El campo '{field}' no debe tener espacios en blanco",
